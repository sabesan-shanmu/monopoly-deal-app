...
from monopoly.api.games.gameActionTracker.resource import game_action_tracker_namespace
...
flask_api.add_namespace(game_action_tracker_namespace,'/api/games/<string:gamePassCode>/game-action-trackers')