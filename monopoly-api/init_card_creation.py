...
def create_properties_card():
    propertiesCards = [
        ...
        PropertiesCard(propertiesCardId=14,name="Park Place",primaryColourId=Enum.Colours.DarkBlue,secondaryColourId=None,price=4,isRotatable=False),
        PropertiesCard(propertiesCardId=15,name="Boardwalk",primaryColourId=Enum.Colours.DarkBlue,secondaryColourId=None,price=4,isRotatable=False),
