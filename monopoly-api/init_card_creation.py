...
def create_game_play_actions():
    game_play_actions = [
        ...
        GamePlayAction(gamePlayActionId=5,colourId=Enum.Colours.Any,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Rent,actionType=Enum.ActionTypes.SinglePlayerRent,expectedGameCardLocation=Enum.GameCardLocationStatus.IsInPlay,isPreCheckRequired=True,description="Play Card with Double the Rent"),
        GamePlayAction(gamePlayActionId=6,colourId=Enum.Colours.Any,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Rent,actionType=Enum.ActionTypes.MultiplePlayerRent,expectedGameCardLocation=Enum.GameCardLocationStatus.IsInPlay,isPreCheckRequired=True,description="Ask Single Player to pay Rent"),
        GamePlayAction(gamePlayActionId=7,colourId=Enum.Colours.Any,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Rent,actionType=Enum.ActionTypes.DoubleTheRent,expectedGameCardLocation=Enum.GameCardLocationStatus.IsInPlay,isPreCheckRequired=True,description="Ask All Players to pay Rent"),
