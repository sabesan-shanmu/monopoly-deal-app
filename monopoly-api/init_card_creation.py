...
def create_game_play_actions():
    game_play_actions = [
        ...
        GamePlayAction(gamePlayActionId=2,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Cash,actionType=Enum.ActionTypes.NoActionRequired,expectedGameCardLocation=Enum.GameCardLocationStatus.IsPlayedOnCashPile,description="Play on Cash Pile"),
        GamePlayAction(gamePlayActionId=3,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Rent,actionType=Enum.ActionTypes.SinglePlayerRent,expectedGameCardLocation=Enum.GameCardLocationStatus.IsPlayedOnCashPile,description="Play on Cash Pile"),
        GamePlayAction(gamePlayActionId=4,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Rent,actionType=Enum.ActionTypes.MultiplePlayerRent,expectedGameCardLocation=Enum.GameCardLocationStatus.IsPlayedOnCashPile,description="Play on Cash Pile"),
        GamePlayAction(gamePlayActionId=5,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Rent,actionType=Enum.ActionTypes.SinglePlayerRent,expectedGameCardLocation=Enum.GameCardLocationStatus.IsInPlay,isPreCheckRequired=True,description="Play Card with Double the Rent"),
        GamePlayAction(gamePlayActionId=6,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Rent,actionType=Enum.ActionTypes.MultiplePlayerRent,expectedGameCardLocation=Enum.GameCardLocationStatus.IsInPlay,isPreCheckRequired=True,description="Ask Single Player to pay Rent"),
        GamePlayAction(gamePlayActionId=7,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Rent,actionType=Enum.ActionTypes.DoubleTheRent,expectedGameCardLocation=Enum.GameCardLocationStatus.IsInPlay,isPreCheckRequired=True,description="Ask All Players to pay Rent"),
        GamePlayAction(gamePlayActionId=8,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Action,actionType=Enum.ActionTypes.Hotel,expectedGameCardLocation=Enum.GameCardLocationStatus.IsPlayedOnCashPile,description="Play on Cash Pile"),
        GamePlayAction(gamePlayActionId=9,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Action,actionType=Enum.ActionTypes.House,expectedGameCardLocation=Enum.GameCardLocationStatus.IsPlayedOnCashPile,description="Play on Cash Pile"),
        GamePlayAction(gamePlayActionId=10,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Action,actionType=Enum.ActionTypes.PassGo,expectedGameCardLocation=Enum.GameCardLocationStatus.IsInPlay,description="Play on Play Pile"),
        GamePlayAction(gamePlayActionId=11,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Action,actionType=Enum.ActionTypes.PassGo,expectedGameCardLocation=Enum.GameCardLocationStatus.IsPlayedOnCashPile,description="Play on Cash Pile"),
        GamePlayAction(gamePlayActionId=12,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Action,actionType=Enum.ActionTypes.DoubleTheRent,expectedGameCardLocation=Enum.GameCardLocationStatus.IsPlayedOnCashPile,description="Play on Cash Pile"),
        GamePlayAction(gamePlayActionId=13,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Action,actionType=Enum.ActionTypes.ItsMyBirthday,expectedGameCardLocation=Enum.GameCardLocationStatus.IsInPlay,isPreCheckRequired=True,description="Play on Play Pile"),
        GamePlayAction(gamePlayActionId=14,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Action,actionType=Enum.ActionTypes.ItsMyBirthday,expectedGameCardLocation=Enum.GameCardLocationStatus.IsPlayedOnCashPile,description="Play on Cash Pile"),
        GamePlayAction(gamePlayActionId=15,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Action,actionType=Enum.ActionTypes.DebtCollector,expectedGameCardLocation=Enum.GameCardLocationStatus.IsInPlay,isPreCheckRequired=True,description="Play on Play Pile"),
        GamePlayAction(gamePlayActionId=16,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Action,actionType=Enum.ActionTypes.DebtCollector,expectedGameCardLocation=Enum.GameCardLocationStatus.IsPlayedOnCashPile,description="Play on Cash Pile"),
        GamePlayAction(gamePlayActionId=17,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Action,actionType=Enum.ActionTypes.JustSayNo,expectedGameCardLocation=Enum.GameCardLocationStatus.IsPlayedOnCashPile,description="Play on Cash Pile"),
        GamePlayAction(gamePlayActionId=18,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Action,actionType=Enum.ActionTypes.SlyDeal,expectedGameCardLocation=Enum.GameCardLocationStatus.IsInPlay,isPreCheckRequired=True,description="Play on Play Pile"),
        GamePlayAction(gamePlayActionId=19,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Action,actionType=Enum.ActionTypes.SlyDeal,expectedGameCardLocation=Enum.GameCardLocationStatus.IsPlayedOnCashPile,description="Play on Cash Pile"),
        GamePlayAction(gamePlayActionId=20,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Action,actionType=Enum.ActionTypes.ForcedDeal,expectedGameCardLocation=Enum.GameCardLocationStatus.IsInPlay,isPreCheckRequired=True,description="Play on Play Pile"),
        GamePlayAction(gamePlayActionId=21,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Action,actionType=Enum.ActionTypes.ForcedDeal,expectedGameCardLocation=Enum.GameCardLocationStatus.IsPlayedOnCashPile,description="Play on Cash Pile"),
        GamePlayAction(gamePlayActionId=22,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Action,actionType=Enum.ActionTypes.DealBreaker,expectedGameCardLocation=Enum.GameCardLocationStatus.IsInPlay,isPreCheckRequired=True,description="Play on Play Pile"),
        GamePlayAction(gamePlayActionId=23,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Action,actionType=Enum.ActionTypes.DealBreaker,expectedGameCardLocation=Enum.GameCardLocationStatus.IsPlayedOnCashPile,description="Play on Cash Pile")
    ]
