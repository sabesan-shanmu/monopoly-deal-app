...
def create_game_play_actions():
    game_play_actions = [
        GamePlayAction(gamePlayActionId=1,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Properties,actionType=None,expectedGameCardLocation=Enum.GameCardLocationStatus.IsPlayedOnPropertyPile,moveClassification=Enum.ActionClassification.NoActionRequiredMove,tradeTypes=None,description="Play on Property Pile",isPreCheckRequired=True),
        GamePlayAction(gamePlayActionId=2,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Cash,actionType=None,expectedGameCardLocation=Enum.GameCardLocationStatus.IsPlayedOnCashPile,moveClassification=Enum.ActionClassification.NoActionRequiredMove,tradeTypes=None,description="Play on Cash Pile"),
        GamePlayAction(gamePlayActionId=3,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Rent,actionType=None,expectedGameCardLocation=Enum.GameCardLocationStatus.IsPlayedOnCashPile,moveClassification=Enum.ActionClassification.NoActionRequiredMove,tradeTypes=None,description="Play on Cash Pile"),
        GamePlayAction(gamePlayActionId=4,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Rent,actionType=None,expectedGameCardLocation=Enum.GameCardLocationStatus.IsInPlay,moveClassification=Enum.ActionClassification.MustPlayDoubleTheRentMove,tradeTypes=None,isPreCheckRequired=True,description="Play Card with Double the Rent"),
        ...
        GamePlayAction(gamePlayActionId=7,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Action,actionType=Enum.ActionTypes.House,expectedGameCardLocation=Enum.GameCardLocationStatus.IsPlayedOnPropertyPile,moveClassification=Enum.ActionClassification.NoActionRequiredMove,tradeTypes=None,isPreCheckRequired=True,description="Play on Property Pile"),
        GamePlayAction(gamePlayActionId=8,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Action,actionType=Enum.ActionTypes.House,expectedGameCardLocation=Enum.GameCardLocationStatus.IsPlayedOnCashPile,moveClassification=Enum.ActionClassification.NoActionRequiredMove,tradeTypes=None,description="Play on Cash Pile"),
        ...
        GamePlayAction(gamePlayActionId=10,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Action,actionType=Enum.ActionTypes.Hotel,expectedGameCardLocation=Enum.GameCardLocationStatus.IsPlayedOnCashPile,moveClassification=Enum.ActionClassification.NoActionRequiredMove,tradeTypes=None,description="Play on Cash Pile"),
        GamePlayAction(gamePlayActionId=11,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Action,actionType=Enum.ActionTypes.PassGo,expectedGameCardLocation=Enum.GameCardLocationStatus.IsInPlay,moveClassification=Enum.ActionClassification.GainCardsMove,tradeTypes=None,description="Play on Play Pile"),
        GamePlayAction(gamePlayActionId=12,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Action,actionType=Enum.ActionTypes.PassGo,expectedGameCardLocation=Enum.GameCardLocationStatus.IsPlayedOnCashPile,moveClassification=Enum.ActionClassification.NoActionRequiredMove,tradeTypes=None,description="Play on Cash Pile"),
        GamePlayAction(gamePlayActionId=13,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Action,actionType=Enum.ActionTypes.DoubleTheRent,expectedGameCardLocation=Enum.GameCardLocationStatus.IsPlayedOnCashPile,moveClassification=Enum.ActionClassification.NoActionRequiredMove,tradeTypes=None,description="Play on Cash Pile"),
        ...
        GamePlayAction(gamePlayActionId=17,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Action,actionType=Enum.ActionTypes.ItsMyBirthday,expectedGameCardLocation=Enum.GameCardLocationStatus.IsPlayedOnCashPile,moveClassification=Enum.ActionClassification.NoActionRequiredMove,tradeTypes=None,description="Play on Cash Pile"),
        ...
        GamePlayAction(gamePlayActionId=19,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Action,actionType=Enum.ActionTypes.DebtCollector,expectedGameCardLocation=Enum.GameCardLocationStatus.IsPlayedOnCashPile,moveClassification=Enum.ActionClassification.NoActionRequiredMove,tradeTypes=None,description="Play on Cash Pile"),
        GamePlayAction(gamePlayActionId=20,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Action,actionType=Enum.ActionTypes.JustSayNo,expectedGameCardLocation=Enum.GameCardLocationStatus.IsInPlay,moveClassification=Enum.ActionClassification.CancelActionMove,tradeTypes=None,isPreCheckRequired=True,description="Play on Play Pile"),
        GamePlayAction(gamePlayActionId=21,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Action,actionType=Enum.ActionTypes.JustSayNo,expectedGameCardLocation=Enum.GameCardLocationStatus.IsPlayedOnCashPile,moveClassification=Enum.ActionClassification.NoActionRequiredMove,tradeTypes=None,description="Play on Cash Pile"),
        GamePlayAction(gamePlayActionId=22,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Action,actionType=Enum.ActionTypes.SlyDeal,expectedGameCardLocation=Enum.GameCardLocationStatus.IsInPlay,moveClassification=Enum.ActionClassification.SlyStealMove,tradeTypes=Enum.TradeTypes.PropertyTrade,isPreCheckRequired=True,description="Play on Play Pile"),
        GamePlayAction(gamePlayActionId=23,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Action,actionType=Enum.ActionTypes.SlyDeal,expectedGameCardLocation=Enum.GameCardLocationStatus.IsPlayedOnCashPile,moveClassification=Enum.ActionClassification.NoActionRequiredMove,tradeTypes=None,description="Play on Cash Pile"),
        ...
        GamePlayAction(gamePlayActionId=25,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Action,actionType=Enum.ActionTypes.ForcedDeal,expectedGameCardLocation=Enum.GameCardLocationStatus.IsPlayedOnCashPile,moveClassification=Enum.ActionClassification.NoActionRequiredMove,tradeTypes=None,description="Play on Cash Pile"),
        ...
        GamePlayAction(gamePlayActionId=27,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Action,actionType=Enum.ActionTypes.DealBreaker,expectedGameCardLocation=Enum.GameCardLocationStatus.IsPlayedOnCashPile,moveClassification=Enum.ActionClassification.NoActionRequiredMove,tradeTypes=None,description="Play on Cash Pile"),
        GamePlayAction(gamePlayActionId=28,currentGameCardLocation=Enum.GameCardLocationStatus.IsPlayedOnPropertyPile,cardType=Enum.CardTypes.Properties,actionType=None,expectedGameCardLocation=Enum.GameCardLocationStatus.IsPlayedOnPropertyPile,moveClassification=Enum.ActionClassification.RotatingCardMove,tradeTypes=None,isPreCheckRequired=True,description="Rotate Card"),
        GamePlayAction(gamePlayActionId=29,currentGameCardLocation=Enum.GameCardLocationStatus.IsPlayedOnPropertyPile,cardType=Enum.CardTypes.Properties,actionType=None,expectedGameCardLocation=Enum.GameCardLocationStatus.IsPlayedOnPropertyPile,moveClassification=Enum.ActionClassification.MovePropertyCardMove,tradeTypes=None,isPreCheckRequired=True,description="Move Card to different Pile")
    ]
