...
def create_game_play_actions():
    game_play_actions = [
        ...
        GamePlayAction(gamePlayActionId=4,currentGameCardLocation=Enum.GameCardLocationStatus.IsOnHand,cardType=Enum.CardTypes.Rent,actionType=Enum.ActionTypes.DoubleTheRent,expectedGameCardLocation=Enum.GameCardLocationStatus.IsInPlay,moveClassification=Enum.ActionClassification.MustPlayDoubleTheRentMove,transactionType=Enum.TransactionType.PlayDoubleTheRent,isPreCheckRequired=True,description="Play Card with Double the Rent"),
