...
Revision ID: e20fffa9db13
Revises: 
Create Date: 2020-08-08 19:09:20.839634
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['currentPlayerId'], ['player.playerId'], name='fk_game_current_player_id', use_alter=True),
    ...
    sa.Column('cardStatus', sa.Enum('IsNotDrawn', 'IsOnHand', 'IsPlayedOnField', 'IsDiscarded', name='gamecardstatus'), nullable=False),
